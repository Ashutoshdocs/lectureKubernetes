...
def application(environ, start_response):
    # Deliberately use an API removed from modern MarkupSafe.
    # This makes the shared-environment failure deterministic.
    message = soft_unicode("BlueForge dependency check passed")
